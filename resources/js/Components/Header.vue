            ...
            <div class="container container-header">
                    ...
                    <nav id="navigation" class="style-1">
                        <ul id="responsive">
                            <li><Link :href="route('home')">Home</Link></li>
                                ...
                                <li v-if="$page.props.auth.user"><Link :href="route('dashboard')">Dashboard</Link></li>
                                ...
                                <li class="d-none d-xl-none d-block d-lg-block"><Link :href="route('login')">Login</Link></li>
                                <li class="d-none d-xl-none d-block d-lg-block"><Link :href="route('register')">Register</Link></li>
                ...
                <div class="header-user-menu user-menu add">
                    <div class="header-user-name">
                        <span><img src="/images/testimonials/ts-1.jpg" alt=""></span><em v-if="$page.props.auth.user">{{$page.props.auth.user.name}}</em><em v-else>Guest</em> !
                    </div>
                    <ul>
                        ...
                        <li v-if="$page.props.auth.user"><Link :href="route('logout')" method="post" as="button">Log Out</Link></li>
                        <li v-if="!$page.props.auth.user"><Link :href="route('login')" as="button">Log In</Link></li>
                    </ul>
                </div>
                <!-- Right Side Content / End -->
                ...
                <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                    ...
                    <div class="header-widget sign-in">
                        <div class="show-reg-form modal-open">
                            <Link v-if="$page.props.auth.user" :href="route('logout')" method="post">Log Out</Link>
