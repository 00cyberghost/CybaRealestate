...
//add and remove class of active from propertycategory
...
$('body').removeClass('inner-pages maxw1600 m0a dashboard-bd ui-elements');
    ...
    <template>
        <Head title="Edit Property Alert" />
                                ...
                                <li id="five">
                                    ...
                                    <div class="tab-content">
                                        <div class="property-form-group">
                                            ...
                                            <div class="row">
                                                <button :disabled="processing" id="submit-button" type="submit" class="mt-5 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray transition ease-in-out duration-150">Edit Alert!</button>
                                            </div>
