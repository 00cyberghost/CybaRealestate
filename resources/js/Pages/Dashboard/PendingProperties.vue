...
const initiateDelete = (id) => {
    ...
    form.delete(route('deleteProperty',id),{
...
const approveProperty = (event) => {

    let id = event.target.getAttribute('property-id')

    const form = useForm()

    form.patch(route('approveProperty',id),{
            ...
            <table class="table-responsive">
                ...
                <tbody v-for="prop in props.data" :key="prop.id">
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <Link class="edit"><i :disabled="processing" preserve-scroll  @click.prevent="approveProperty" :property-id="prop.id" class="fas fa-check"></i></Link>
