...
<template>
    ...
    <Head v-if="props.data.length > 0">
        <title>Houses, Flats, Lands and real estate for {{ props.data[0].category }} in my area and Nigeria ({{ stat.statcount }} available)</title>
    ...
    <!-- START SECTION PROPERTIES LISTING -->
        <section class="properties-list featured portfolio blog">
            <div class="container">
                ...
                <div class="property-location curved mb-5" v-if="props.data.length > 0">
                    
                    <p> 
                        <span v-if="stat">
                        There are {{ stat.statcount }} listings  for {{ props.data[0].category }}  in Nigeria.
                        The average price of listings for {{ props.data[0].category }} in Nigeria is ₦{{ stat.average }}. 
